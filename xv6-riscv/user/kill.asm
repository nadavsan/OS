...
main(int argc, char **argv)
{
  ...
  2c:	1e4080e7          	jalr	484(ra) # 20c <atoi>
  30:	00000097          	auipc	ra,0x0
  34:	30c080e7          	jalr	780(ra) # 33c <kill>
  for(i=1; i<argc; i++)
  38:	04a1                	addi	s1,s1,8
  3a:	ff2496e3          	bne	s1,s2,26 <main+0x26>
  exit(0,"");
  3e:	00001597          	auipc	a1,0x1
  42:	82a58593          	addi	a1,a1,-2006 # 868 <malloc+0xfe>
  46:	4501                	li	a0,0
  48:	00000097          	auipc	ra,0x0
  4c:	2c4080e7          	jalr	708(ra) # 30c <exit>
    fprintf(2, "usage: kill pid...\n");
  50:	00001597          	auipc	a1,0x1
  54:	80058593          	addi	a1,a1,-2048 # 850 <malloc+0xe6>
  58:	4509                	li	a0,2
  5a:	00000097          	auipc	ra,0x0
  5e:	624080e7          	jalr	1572(ra) # 67e <fprintf>
    exit(1,"");
  62:	00001597          	auipc	a1,0x1
  66:	80658593          	addi	a1,a1,-2042 # 868 <malloc+0xfe>
  6a:	4505                	li	a0,1
  6c:	00000097          	auipc	ra,0x0
  70:	2a0080e7          	jalr	672(ra) # 30c <exit>
...
_main()
{
  ...
  88:	7e458593          	addi	a1,a1,2020 # 868 <malloc+0xfe>
  8c:	4501                	li	a0,0
...
00000000000003b4 <set_ps_priority>:
...
00000000000003bc <set_cfs_priority>:
...
00000000000003c4 <get_cfs_stats>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41c:	46050513          	addi	a0,a0,1120 # 878 <digits>
 420:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	394b8b93          	addi	s7,s7,916 # 878 <digits>
 ...
 628:	24c90913          	addi	s2,s2,588 # 870 <malloc+0x106>
        while(*s != 0){
