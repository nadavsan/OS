...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   a:	478d                	li	a5,3
   c:	02f50463          	beq	a0,a5,34 <main+0x34>
    fprintf(2, "Usage: ln old new\n");
  10:	00001597          	auipc	a1,0x1
  14:	84058593          	addi	a1,a1,-1984 # 850 <malloc+0xea>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	660080e7          	jalr	1632(ra) # 67a <fprintf>
    exit(1,"");
  22:	00001597          	auipc	a1,0x1
  26:	84658593          	addi	a1,a1,-1978 # 868 <malloc+0x102>
  2a:	4505                	li	a0,1
  2c:	00000097          	auipc	ra,0x0
  30:	2dc080e7          	jalr	732(ra) # 308 <exit>
  34:	84ae                	mv	s1,a1
  }
  ...
  3e:	32e080e7          	jalr	814(ra) # 368 <link>
  42:	00054b63          	bltz	a0,58 <main+0x58>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0,"");
  46:	00001597          	auipc	a1,0x1
  4a:	82258593          	addi	a1,a1,-2014 # 868 <malloc+0x102>
  4e:	4501                	li	a0,0
  ...
  60:	81458593          	addi	a1,a1,-2028 # 870 <malloc+0x10a>
  64:	4509                	li	a0,2
  66:	00000097          	auipc	ra,0x0
  6a:	614080e7          	jalr	1556(ra) # 67a <fprintf>
  6e:	bfe1                	j	46 <main+0x46>
...
_main()
{
  ...
  exit(0,"");
  80:	00000597          	auipc	a1,0x0
  84:	7e858593          	addi	a1,a1,2024 # 868 <malloc+0x102>
  88:	4501                	li	a0,0
...
00000000000003b8 <set_cfs_priority>:
...
00000000000003c0 <get_cfs_stats>:
