...
main(int argc, char *argv[])
{
  ...
  1a:	91278793          	addi	a5,a5,-1774 # 928 <malloc+0x11c>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8c450513          	addi	a0,a0,-1852 # 8f0 <malloc+0xe4>
  34:	00000097          	auipc	ra,0x0
  38:	71a080e7          	jalr	1818(ra) # 74e <printf>
  memset(data, 'a', sizeof(data));
  3c:	20000613          	li	a2,512
  40:	06100593          	li	a1,97
  44:	dd040513          	addi	a0,s0,-560
  48:	00000097          	auipc	ra,0x0
  4c:	162080e7          	jalr	354(ra) # 1aa <memset>
  ...
  58:	352080e7          	jalr	850(ra) # 3a6 <fork>
  ...
  6c:	8a050513          	addi	a0,a0,-1888 # 908 <malloc+0xfc>
  70:	00000097          	auipc	ra,0x0
  74:	6de080e7          	jalr	1758(ra) # 74e <printf>
  ...
  8e:	364080e7          	jalr	868(ra) # 3ee <open>
  92:	892a                	mv	s2,a0
  94:	44d1                	li	s1,20
  for(i = 0; i < 20; i++)
//    printf(fd, "%d\n", i);
  ...
  a4:	32e080e7          	jalr	814(ra) # 3ce <write>
  for(i = 0; i < 20; i++)
  ...
  b2:	328080e7          	jalr	808(ra) # 3d6 <close>

  printf("read\n");
  b6:	00001517          	auipc	a0,0x1
  ba:	86250513          	addi	a0,a0,-1950 # 918 <malloc+0x10c>
  be:	00000097          	auipc	ra,0x0
  c2:	690080e7          	jalr	1680(ra) # 74e <printf>

  fd = open(path, O_RDONLY);
  c6:	4581                	li	a1,0
  c8:	fd040513          	addi	a0,s0,-48
  cc:	00000097          	auipc	ra,0x0
  d0:	322080e7          	jalr	802(ra) # 3ee <open>
  d4:	892a                	mv	s2,a0
  d6:	44d1                	li	s1,20
  for (i = 0; i < 20; i++)
  ...
  e6:	2e4080e7          	jalr	740(ra) # 3c6 <read>
  for (i = 0; i < 20; i++)
  ...
  f4:	2e6080e7          	jalr	742(ra) # 3d6 <close>

  wait(0,0);
  f8:	4581                	li	a1,0
  fa:	4501                	li	a0,0
  fc:	00000097          	auipc	ra,0x0
 100:	2ba080e7          	jalr	698(ra) # 3b6 <wait>

  exit(0,"");
 104:	00001597          	auipc	a1,0x1
 108:	81c58593          	addi	a1,a1,-2020 # 920 <malloc+0x114>
 10c:	4501                	li	a0,0
 10e:	00000097          	auipc	ra,0x0
 112:	2a0080e7          	jalr	672(ra) # 3ae <exit>
...
_main()
{
 ...
 122:	ee2080e7          	jalr	-286(ra) # 0 <main>
  exit(0,"");
 126:	00000597          	auipc	a1,0x0
 12a:	7fa58593          	addi	a1,a1,2042 # 920 <malloc+0x114>
 12e:	4501                	li	a0,0
...
0000000000000456 <set_ps_priority>:
...
000000000000045e <set_cfs_priority>:
...
0000000000000466 <get_cfs_stats>:
