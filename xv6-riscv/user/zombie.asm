...
main(void)
{
  ...
  22:	2ac080e7          	jalr	684(ra) # 2ca <exit>
    sleep(5);  // Let child exit before parent.
  26:	4515                	li	a0,5
  28:	00000097          	auipc	ra,0x0
  2c:	332080e7          	jalr	818(ra) # 35a <sleep>
...
_main()
{
  ...
  50:	27e080e7          	jalr	638(ra) # 2ca <exit>
...
000000000000037a <set_cfs_priority>:
...
0000000000000382 <get_cfs_stats>:
...
malloc(uint nbytes)
{
 ...
 800:	b56080e7          	jalr	-1194(ra) # 352 <sbrk>
  if(p == (char*)-1)
