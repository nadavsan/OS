...
int main(int argc, char *argv[]) {
  ...
  exit(0, "Goodbye World xv6");
   ...
   c:	7f858593          	addi	a1,a1,2040 # 800 <malloc+0xf0>
  10:	4501                	li	a0,0
  12:	00000097          	auipc	ra,0x0
  16:	2a0080e7          	jalr	672(ra) # 2b2 <exit>
...
_main()
{
  ...
  2e:	7ee58593          	addi	a1,a1,2030 # 818 <malloc+0x108>
  32:	4501                	li	a0,0
...
000000000000035a <set_ps_priority>:
...
0000000000000362 <set_cfs_priority>:
...
000000000000036a <get_cfs_stats>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	46a50513          	addi	a0,a0,1130 # 828 <digits>
 3c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	39eb8b93          	addi	s7,s7,926 # 828 <digits>
 ...
 5ce:	25690913          	addi	s2,s2,598 # 820 <malloc+0x110>
        while(*s != 0){
