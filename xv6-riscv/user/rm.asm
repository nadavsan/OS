...
main(int argc, char *argv[])
{
  ...
  2e:	346080e7          	jalr	838(ra) # 370 <unlink>
  ...
  54:	85058593          	addi	a1,a1,-1968 # 8a0 <malloc+0x122>
  58:	4505                	li	a0,1
  5a:	00000097          	auipc	ra,0x0
  5e:	2c6080e7          	jalr	710(ra) # 320 <exit>
      fprintf(2, "rm: %s failed to delete\n", argv[i]);
  62:	6090                	ld	a2,0(s1)
  64:	00001597          	auipc	a1,0x1
  68:	82458593          	addi	a1,a1,-2012 # 888 <malloc+0x10a>
  6c:	4509                	li	a0,2
  ...
  7a:	82a58593          	addi	a1,a1,-2006 # 8a0 <malloc+0x122>
  7e:	4501                	li	a0,0
  80:	00000097          	auipc	ra,0x0
  84:	2a0080e7          	jalr	672(ra) # 320 <exit>
...
_main()
{
  ...
  9c:	80858593          	addi	a1,a1,-2040 # 8a0 <malloc+0x122>
  a0:	4501                	li	a0,0
...
00000000000003c8 <set_ps_priority>:
...
00000000000003d0 <set_cfs_priority>:
...
00000000000003d8 <get_cfs_stats>:
...
putc(int fd, char c)
{
 ...
 3fe:	f46080e7          	jalr	-186(ra) # 340 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 430:	48450513          	addi	a0,a0,1156 # 8b0 <digits>
 434:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fc:	3b8b8b93          	addi	s7,s7,952 # 8b0 <digits>
 ...
 63c:	27090913          	addi	s2,s2,624 # 8a8 <malloc+0x12a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 856:	b56080e7          	jalr	-1194(ra) # 3a8 <sbrk>
  if(p == (char*)-1)
