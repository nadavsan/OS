...
int main(int argc, char *argv[]) {
   ...
   e:	3ae080e7          	jalr	942(ra) # 3b8 <memsize>
  12:	85aa                	mv	a1,a0
    printf("Memory size before allocation: %d bytes\n",mem_size);
  14:	00001517          	auipc	a0,0x1
  18:	84c50513          	addi	a0,a0,-1972 # 860 <malloc+0xea>
  1c:	00000097          	auipc	ra,0x0
  20:	69c080e7          	jalr	1692(ra) # 6b8 <printf>

    // Allocate 20k more bytes of memory
    p = malloc(20 * KB);
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	750080e7          	jalr	1872(ra) # 776 <malloc>
  2e:	84aa                	mv	s1,a0

    // Get memory size after allocation
    mem_size = memsize();
  30:	00000097          	auipc	ra,0x0
  34:	388080e7          	jalr	904(ra) # 3b8 <memsize>
  38:	85aa                	mv	a1,a0

    printf("Memory size after allocation: %d bytes\n",mem_size);
  3a:	00001517          	auipc	a0,0x1
  3e:	85650513          	addi	a0,a0,-1962 # 890 <malloc+0x11a>
  42:	00000097          	auipc	ra,0x0
  46:	676080e7          	jalr	1654(ra) # 6b8 <printf>

    // Free the allocated array
    free(p);
  4a:	8526                	mv	a0,s1
  4c:	00000097          	auipc	ra,0x0
  50:	6a2080e7          	jalr	1698(ra) # 6ee <free>

    // Get memory size after freeing the allocated memory
    mem_size = memsize();
  54:	00000097          	auipc	ra,0x0
  58:	364080e7          	jalr	868(ra) # 3b8 <memsize>
  5c:	85aa                	mv	a1,a0

    printf("Memory size after freeing the allocation: %d bytes\n",mem_size);
  5e:	00001517          	auipc	a0,0x1
  62:	85a50513          	addi	a0,a0,-1958 # 8b8 <malloc+0x142>
  66:	00000097          	auipc	ra,0x0
  6a:	652080e7          	jalr	1618(ra) # 6b8 <printf>

    exit(0,"");
  6e:	00001597          	auipc	a1,0x1
  72:	81a58593          	addi	a1,a1,-2022 # 888 <malloc+0x112>
  76:	4501                	li	a0,0
  78:	00000097          	auipc	ra,0x0
  7c:	2a0080e7          	jalr	672(ra) # 318 <exit>
...
_main()
{
  ...
  94:	7f858593          	addi	a1,a1,2040 # 888 <malloc+0x112>
  98:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f4:	408b8b93          	addi	s7,s7,1032 # 8f8 <digits>
 ...
 634:	2c090913          	addi	s2,s2,704 # 8f0 <malloc+0x17a>
        while(*s != 0){
