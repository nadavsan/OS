...
int main(int argc, char *argv[]) {
   ...
   e:	39e080e7          	jalr	926(ra) # 3a8 <memsize>
  12:	85aa                	mv	a1,a0
    printf("Memory size before allocation: %d bytes\n",mem_size);
  14:	00001517          	auipc	a0,0x1
  18:	81c50513          	addi	a0,a0,-2020 # 830 <malloc+0xea>
  1c:	00000097          	auipc	ra,0x0
  20:	66c080e7          	jalr	1644(ra) # 688 <printf>

    // Allocate 20k more bytes of memory
    p = malloc(20 * KB);
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	720080e7          	jalr	1824(ra) # 746 <malloc>
  2e:	84aa                	mv	s1,a0

    // Get memory size after allocation
    mem_size = memsize();
  30:	00000097          	auipc	ra,0x0
  34:	378080e7          	jalr	888(ra) # 3a8 <memsize>
  38:	85aa                	mv	a1,a0

    printf("Memory size after allocation: %d bytes\n",mem_size);
  3a:	00001517          	auipc	a0,0x1
  3e:	82650513          	addi	a0,a0,-2010 # 860 <malloc+0x11a>
  42:	00000097          	auipc	ra,0x0
  46:	646080e7          	jalr	1606(ra) # 688 <printf>

    // Free the allocated array
    free(p);
  4a:	8526                	mv	a0,s1
  4c:	00000097          	auipc	ra,0x0
  50:	672080e7          	jalr	1650(ra) # 6be <free>

    // Get memory size after freeing the allocated memory
    mem_size = memsize();
  54:	00000097          	auipc	ra,0x0
  58:	354080e7          	jalr	852(ra) # 3a8 <memsize>
  5c:	85aa                	mv	a1,a0

    printf("Memory size after freeing the allocation: %d bytes\n",mem_size);
  5e:	00001517          	auipc	a0,0x1
  62:	82a50513          	addi	a0,a0,-2006 # 888 <malloc+0x142>
  66:	00000097          	auipc	ra,0x0
  6a:	622080e7          	jalr	1570(ra) # 688 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	4d450513          	addi	a0,a0,1236 # 8c8 <digits>
 3fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 604:	2c090913          	addi	s2,s2,704 # 8c0 <malloc+0x17a>
        while(*s != 0){
