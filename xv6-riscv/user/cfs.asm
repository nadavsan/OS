...
int main(){
  ...
  1c:	368080e7          	jalr	872(ra) # 380 <fork>
  20:	84aa                	mv	s1,a0
        if (pid == -1) {
  22:	05450763          	beq	a0,s4,70 <main+0x70>
            exit(1, "");

        } else if (pid == 0) 
  26:	cd31                	beqz	a0,82 <main+0x82>
            }
            ...
            child_pid[i] = pid;
  28:	00a9a423          	sw	a0,8(s3)
    for (int i = 2; i >= 0; i--) {
  2c:	397d                	addiw	s2,s2,-1
  2e:	19f1                	addi	s3,s3,-4
  30:	ff4914e3          	bne	s2,s4,18 <main+0x18>
        }
    }
    for (int i = 0; i < 3; i++) {
        wait(&child_pid[i], 0);
  34:	4581                	li	a1,0
  36:	fc040513          	addi	a0,s0,-64
  3a:	00000097          	auipc	ra,0x0
  3e:	356080e7          	jalr	854(ra) # 390 <wait>
  42:	4581                	li	a1,0
  44:	fc440513          	addi	a0,s0,-60
  48:	00000097          	auipc	ra,0x0
  4c:	348080e7          	jalr	840(ra) # 390 <wait>
  50:	4581                	li	a1,0
  52:	fc840513          	addi	a0,s0,-56
  56:	00000097          	auipc	ra,0x0
  5a:	33a080e7          	jalr	826(ra) # 390 <wait>
    }
    return 0;
  ...
  68:	79a2                	ld	s3,40(sp)
  6a:	7a02                	ld	s4,32(sp)
  6c:	6161                	addi	sp,sp,80
  6e:	8082                	ret
            exit(1, "");
  70:	00001597          	auipc	a1,0x1
  74:	86058593          	addi	a1,a1,-1952 # 8d0 <malloc+0xea>
  78:	4505                	li	a0,1
  7a:	00000097          	auipc	ra,0x0
  7e:	30e080e7          	jalr	782(ra) # 388 <exit>
            set_cfs_priority(i);
  82:	854a                	mv	a0,s2
  84:	00000097          	auipc	ra,0x0
  88:	3b4080e7          	jalr	948(ra) # 438 <set_cfs_priority>
                if (j%100000==0)
  8c:	69e1                	lui	s3,0x18
  8e:	6a09899b          	addiw	s3,s3,1696
            for (int j=0;j<1000000;j++)
  92:	000f4937          	lui	s2,0xf4
  96:	24090913          	addi	s2,s2,576 # f4240 <base+0xf3230>
  9a:	a809                	j	ac <main+0xac>
                    sleep(1);
  9c:	4505                	li	a0,1
  9e:	00000097          	auipc	ra,0x0
  a2:	37a080e7          	jalr	890(ra) # 418 <sleep>
            for (int j=0;j<1000000;j++)
  a6:	2485                	addiw	s1,s1,1
  a8:	01248663          	beq	s1,s2,b4 <main+0xb4>
                if (j%100000==0)
  ac:	0334e7bb          	remw	a5,s1,s3
  b0:	fbfd                	bnez	a5,a6 <main+0xa6>
  b2:	b7ed                	j	9c <main+0x9c>
            if(get_cfs_stats(getpid(),arr) < 0){
  b4:	00000097          	auipc	ra,0x0
  b8:	354080e7          	jalr	852(ra) # 408 <getpid>
  bc:	fb040593          	addi	a1,s0,-80
  c0:	00000097          	auipc	ra,0x0
  c4:	380080e7          	jalr	896(ra) # 440 <get_cfs_stats>
  c8:	00054b63          	bltz	a0,de <main+0xde>
            exit(0, "");
  cc:	00001597          	auipc	a1,0x1
  d0:	80458593          	addi	a1,a1,-2044 # 8d0 <malloc+0xea>
  d4:	4501                	li	a0,0
  d6:	00000097          	auipc	ra,0x0
  da:	2b2080e7          	jalr	690(ra) # 388 <exit>
                exit(1, "get_cfs_stats failed");
  de:	00000597          	auipc	a1,0x0
  e2:	7fa58593          	addi	a1,a1,2042 # 8d8 <malloc+0xf2>
  e6:	4505                	li	a0,1
  e8:	00000097          	auipc	ra,0x0
  ec:	2a0080e7          	jalr	672(ra) # 388 <exit>
...
_main()
{
 ...
 104:	7d058593          	addi	a1,a1,2000 # 8d0 <malloc+0xea>
 108:	4501                	li	a0,0
...
gets(char *buf, int max)
{
 ...
 226:	00098023          	sb	zero,0(s3) # 18000 <base+0x16ff0>
  return buf;
}
 22a:	855e                	mv	a0,s7
...
0000000000000430 <set_ps_priority>:
...
0000000000000438 <set_cfs_priority>:
...
0000000000000440 <get_cfs_stats>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	46450513          	addi	a0,a0,1124 # 8f8 <digits>
 49c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	398b8b93          	addi	s7,s7,920 # 8f8 <digits>
 ...
 6a4:	25090913          	addi	s2,s2,592 # 8f0 <malloc+0x10a>
        while(*s != 0){
